                ...
                <table class="table table-bordered table-hover" style="table-layout: fixed; min-width: 1650px;">
                  <thead>
                    <tr>
                      ...
                      <th>Surface</th>
                      <th style="width: 255px;">Specification</th>
                      <th style="width: 120px;">Prix</th>
                      <th>Wilaya</th>
                      <th>Commune</th>
                      <th>City</th>
                      <th style="width: 220px;">Telephone de propriétaire</th>
                      <th>Date</th>
                    </tr>
                  </thead>
                  <tbody>
                    @foreach($data as $item)
                      <tr class="tr" data-widget="expandable-table" aria-expanded="false">
                        <td id="id"><p>{{$item->id}}</p></td>
